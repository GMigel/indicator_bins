...
#else
/**
 * @brief Массив строк главного меню.
 *
 * Каждая строка соответствует одному пункту меню.
 */
...
//------------------------------------------------------------------------------
/**
 * @brief Глобальное состояние графического интерфейса.
 *
 * Структура хранит текущие измеренные параметры, флаги их валидности,
 * выбранные режимы отображения и активное меню.
 *
 * Используется всеми модулями GUI для отрисовки и обработки логики.
 */
...
//------------------------------------------------------------------------------
/**
 * @brief Обработка изменения опорного давления.
 *
 * Изменяет значение давления в зависимости от выбранных единиц
 * и типа давления (QFE/QNH).
 *
 * @param[in] delta Изменение положения энкодера.
 */
...
//------------------------------------------------------------------------------
/**
 * @brief Обработка поворота энкодера в меню.
 *
 * Изменяет текущий выбранный пункт меню.
 *
 * @param[in] delta Величина изменения положения энкодера.
 *                  Положительное значение — следующий пункт,
 *                  отрицательное — предыдущий.
 */
...
//------------------------------------------------------------------------------
/**
 * @brief Обработка выбора текущего пункта меню.
 *
 * Вызывает callback-функцию, связанную с выбранным пунктом.
 */
