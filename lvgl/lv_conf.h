...
#define LV_DISP_ROT_MAX_BUF (16U*1024U) // 32
...
#define LV_ATTRIBUTE_MEM_ALIGN_SIZE 8
...
#define LV_FONT_CUSTOM_DECLARE	LV_FONT_DECLARE(lv_font_sans10) LV_FONT_DECLARE(lv_font_sans14) LV_FONT_DECLARE(lv_font_sans16) LV_FONT_DECLARE(lv_font_sans18)

/*Always set a default font*/
#define LV_FONT_DEFAULT &lv_font_sans10
